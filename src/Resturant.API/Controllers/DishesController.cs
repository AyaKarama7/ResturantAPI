...
namespace Resturant.API.Controllers
{
    ...
    public class DishesController(IMediator mediator) : ControllerBase
    {
        ...
        [Authorize(Roles = $"{UserRoles.User},{UserRoles.Owner}")]
        public async Task<IActionResult> GetDishForResturantById([FromRoute] int resturantId, int dishId)
        {
        ...
        [HttpPatch]
        [Authorize(Roles = UserRoles.Owner)]
        public async Task<IActionResult> UpdateDishInResturant([FromRoute] int resturantId, int dishId, [FromBody] DishUpdateCommand dish)
        {
